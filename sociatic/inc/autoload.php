...
/**
 * Autoloader function for Sociatic theme classes
 *
 * @param string $class The fully-qualified class name.
 * @return void
 */
function sociatic_autoloader( $class ) {
    $prefix   = 'Sociatic';
    $base_dir = SOCIATIC_DIR . 'inc/class/';
    $len      = strlen( $prefix );
...
spl_autoload_register( 'sociatic_autoloader' );
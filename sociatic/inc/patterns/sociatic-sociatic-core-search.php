...
<div class="wp-block-column" style="flex-basis:80%"><!-- wp:query-title {"type":"search","className":" sociatic-animate sociatic-move-up sociatic-delay-1","style":{"typography":{"fontStyle":"normal","fontWeight":"800","lineHeight":"1.2"}},"textColor":"gv-color-text-primary","fontSize":"heading-page","fontFamily":"mulish"} /--></div>
<!-- /wp:column -->

 ...
 */
return array(
	'title'      => __( 'Sociatic Gutenverse Blog Hero', 'sociatic' ),
...
<div class="wp-block-gutenverse-column guten-element guten-column guten-YPBrSm"><div class="guten-background-overlay"></div><div class="sticky-wrapper" data-id="YPBrSm"><div class="guten-column-wrapper"><!-- wp:gutenverse/heading {"elementId":"guten-NAcgD9","type":1,"color":{"type":"variable","id":"theme-1"},"typography":{"type":"variable","id":"1Isv3n","font":{"label":"Muli","value":"Muli","type":"google"},"size":{"Desktop":{"point":"56","unit":"px"},"Mobile":{"point":"36","unit":"px"},"Tablet":{"point":"44","unit":"px"}},"lineHeight":{"Desktop":{"unit":"em","point":"1.1"}},"weight":"800"},"margin":{"Desktop":{"unit":"px","dimension":{"top":"0","right":"0","bottom":"20","left":"0"}}},"padding":{"Desktop":[]},"animation":{"type":{"Desktop":"fadeInUp"},"duration":"normal"},"advanceAnimation":{"actions":[],"loadOn":"hover"}} -->
<h1 class="wp-block-gutenverse-heading guten-element guten-NAcgD9 animated guten-element-hide desktop-fadeInUp">Blog</h1>
...
<div class="guten-element guten-icon-list-item guten-L9u32O"><a id="guten-L9u32O"><i class="fas fa-chevron-right"></i><span class="list-text ">Blog</span></a></div>

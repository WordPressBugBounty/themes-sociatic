 ...
 */
return array(
	'title'      => __( 'Sociatic Core Index', 'sociatic' ),
...
<div class="wp-block-column" style="flex-basis:80%"><!-- wp:post-title {"level":1,"className":"sociatic-animate sociatic-move-up sociatic-delay-1","style":{"typography":{"fontStyle":"normal","fontWeight":"800","lineHeight":"1.1"}},"textColor":"gv-color-text-primary","fontSize":"heading-page","fontFamily":"mulish"} /--></div>
<!-- /wp:column -->
